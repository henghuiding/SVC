function AutotestIFCN_PascalContext3(networkfolder)
...
%     prob = medfilt3(prob);
%     prob(4:end-3,4:end-3,:)=prob(4:end-3,4:end-3,:);
    [~,pred] = max(prob, [], 3);
    pred2 = medfilt2(pred, [17,17], 'symmetric');
    pred(17:end-16,17:end-16)=pred2(17:end-16,17:end-16);
