function accuracy = testIFCN_PascalContext()
...
netFn{end+1} = sprintf('PascalContext_%d_Val/Feedback(Polsize3-gaus17x17_sigma3_w=0.5-1.2)-pretrained-batch-ires4s-3x3-6layers-101-dag-1e-3-higher3/net-BN-val.mat', imageSize); 
